...
if(isset($_POST['email'])) {
    ...
    $email_subject = "MedPay Form Submission";
...
echo "<script>alert('thank you, someone will reach out shortly')</script> <meta http-equiv='refresh' content=\"0; url=http://getmedpay.com\">";
?>
